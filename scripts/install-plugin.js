...
function getPluginDir () {
    switch (process.platform) {
        case 'darwin':
            return path.join(os.homedir(), 'Library', 'Application Support', 'tabby', 'plugins', 'node_modules', 'tabby-aws-ssm-ssh')
        case 'win32':
            return path.join(process.env.APPDATA, 'tabby', 'plugins', 'node_modules', 'tabby-aws-ssm-ssh')
        default:
            return path.join(os.homedir(), '.config', 'tabby', 'plugins', 'node_modules', 'tabby-aws-ssm-ssh')
    }
}
